...
func TestPrinter_ExportData(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			output: "{\"clusterRoleBindings\":[{\"name\":\"Bob-and-Eve-can-view-pods\",\"roleRef\":{\"apiGroup\":\"\",\"kind\":\"\",\"name\":\"\"},\"subjects\":[{\"kind\":\"ServiceAccount\",\"name\":\"Bob\",\"namespace\":\"foo\"},{\"kind\":\"User\",\"name\":\"Eve\"}]}],\"roleBindings\":[{\"name\":\"Alice-can-view-pods\",\"roleRef\":{\"apiGroup\":\"\",\"kind\":\"\",\"name\":\"\"},\"subjects\":[{\"kind\":\"User\",\"name\":\"Alice\"}]},{\"name\":\"Admins-can-view-pods\",\"roleRef\":{\"apiGroup\":\"\",\"kind\":\"\",\"name\":\"\"},\"subjects\":[{\"kind\":\"Group\",\"name\":\"Admins\"}]}]}\n",
		},
		{
			scenario: "E",
			verb:     "get", resource: "pods",
			...
			wide: true,
			output: "{\"clusterRoleBindings\":[{\"name\":\"Bob-and-Eve-can-view-pods\",\"roleRef\":{\"apiGroup\":\"\",\"kind\":\"ClusterRole\",\"name\":\"view\"},\"subjects\":[{\"kind\":\"ServiceAccount\",\"name\":\"Bob\",\"namespace\":\"foo\"},{\"kind\":\"User\",\"name\":\"Eve\"}]}],\"roleBindings\":[{\"name\":\"Alice-can-view-pods\",\"roleRef\":{\"apiGroup\":\"\",\"kind\":\"Role\",\"name\":\"view-pods\"},\"subjects\":[{\"kind\":\"User\",\"name\":\"Alice\"}]},{\"name\":\"Admins-can-view-pods\",\"roleRef\":{\"apiGroup\":\"\",\"kind\":\"ClusterRole\",\"name\":\"view\"},\"subjects\":[{\"kind\":\"Group\",\"name\":\"Admins\"}]}]}\n",
		},
	}
